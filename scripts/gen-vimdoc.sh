#!/usr/bin/env bash
#
# Generate doc/nxvim-keys-helper.txt (the vimdoc help file) from
# doc/nxvim-keys-helper.md using panvimdoc <https://github.com/kdheepak/panvimdoc>
...
# file is never hand-aligned. Edit doc/nxvim-keys-helper.md, then run this.
#
...
# --- per-plugin settings -----------------------------------------------------
PROJECT="nxvim-keys-helper"                # → :help nxvim-keys-helper
DESCRIPTION="A which-key popup for nxvim"  # header tagline (line 1)
# -----------------------------------------------------------------------------
